...
# Define the shared memory name, shape, and dtype
shared_mem_name = 'camera1_shared_mem'
...
# Create a shared memory block for the camera feed (only need to do this once)
